...
* Sanger original sequence data (.ab1 trace files) are available in the DRYAD repositoty <A HREF="https://datadryad.org/stash/dataset/doi:10.5061/dryad.4mw6m906j"> here</A>. Each subfolder can contain more than one fragment from the same reference contig, in which case most fragments but not all are overlapping. More than 85% of the amplicons yielded at least 12 high-quality sequences. All subfolders contain at least one sequence that is of very good Sanger quality. 
