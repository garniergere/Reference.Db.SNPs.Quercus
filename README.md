...
* Both Tables S3 and S4 "Species" samples exclude the 2 most introgressed individuals of the discovery panel (based on STRUCTURE analyses), for Gst and Gst' statistics to be meaningful. A similar list is available <A HREF="Genes.and.SNPs"> in Variant.Table.no4introgressed.xlsx file</A>, which excludes the 4 most introgressed individuals.
