...
# 3) download the R script and 
# run it in command line with the input files given as examples in the same directory (alternatively, 
# change the "txt.folder" argument of the mreps.parse FUN in the script where MREPS output txt files would be copied).
